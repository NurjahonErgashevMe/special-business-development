        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 my-16 mx-5 gap-14 manage">
          {filteredData.map((items, i) => (
            <div className="manageTabs text-center p-10" key={i}>
              ...
              <button className="text-sm font-bold text-mainColor bg-transparent hover:bg-mainColor hover:text-white border-2 border-mainColor rounded-full py-4 px-12 mb-6">
                {items.button}
              </button>
